        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreEmail = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingAddressSnapshot_FullName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShippingAddressSnapshot_PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShippingStreet = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShippingAddressSnapshot_Street2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StoreCategories_Vendors_VendorId",
                        column: x => x.VendorId,
                        principalTable: "Vendors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WithdrawalRequests_Vendors_VendorId",
                        column: x => x.VendorId,
                        principalTable: "Vendors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dimensions_Length = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    Dimensions_Width = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    Dimensions_Height = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    Dimensions_Unit = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_ProductId_CustomerId_OrderId",
                table: "Reviews",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoreCategories_VendorId_Slug",
                table: "StoreCategories",
                columns: new[] { "VendorId", "Slug" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Vendors_StoreEmail",
                table: "Vendors",
                column: "StoreEmail",
                unique: true,
                filter: "[StoreEmail] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WithdrawalRequests_VendorId",
